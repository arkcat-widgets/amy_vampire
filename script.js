  ...
  switch (eventKey) {
    ...
    case "subscriber-subscriber-latest":
      ...
      if (event.bulkGifted === true) {
        ...
        queueTextPathWithFlip(`${name} gifted ${bulkAmount} subs!`);
      ...
      queueTextPathWithFlip(`${name} subscribed!`);
      playFollowAnimation();
      return;
    ...
    case "tip-tip-latest":
      ...
      if (tipAmount > 0) {
        queueTextPathWithFlip(`${name} tipped ${tipAmount}!`);
    ...
    case "donation-donation-latest":
      ...
      if (donationAmount > 0) {
        queueTextPathWithFlip(`${name} donated ${donationAmount}!`);
    ...
    case "bits-bits-latest":
      ...
      if (cheerAmount > 0) {
        queueTextPathWithFlip(`${name} cheered ${cheerAmount} bits!`);
    ...
    case "host-host-latest":
      ...
      queueTextPathWithFlip(`${name} hosted with ${viewers} viewers!`);
    ...
    case "raid-raid-latest":
      ...
      queueTextPathWithFlip(`${name} raided with ${raiders} raiders!`);
